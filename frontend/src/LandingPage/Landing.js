    ...
    <div className="pageBody">
      <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <div className="container">
          ...
          />
          <h3 className="navbar-nav linkText px-2" href="/">
            JIIT Project Portal
          </h3>
          <button
        ...
        <div className="container pt-3">
          <div className="row align-items-center justify-content-center">
            <div className="col-md-5">
              <h1>Welcome to JIIT!</h1>
              <p>
                <span>A space where you can make your dreams come true.</span>
              </p>
              <Link
                type="button"
      ...
      <section className="feature gradient">
        ...
        <div className="container" role="complementary">
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-md-5">
              <h2 className="my-3 px-2">What can JIIT Project Portal do?</h2>
              <p className="my-4 px-2">
                JIIT Project Portal is reimaging how project management can be
                done. By streamlining the process and giving you a place to keep
                track of all of your projects, you no longer need to go anywhere
                else to keep track of your work.
              </p>
              <ul px-2>
      ...
      <div className="container mb-3">{/* <Footer /> */}</div>
    </div>
  );
};
